		...
		special: {
			...
			values: {
				...
				set: function(values){
					...
					setupMO(this, function(){
						var currentValues = attr.get(this, "values");
						var lastDispatchedValues = setData.get.call(this, "lastDispatchedValues") || currentValues; // if we haven't dispatched before then assume DOM has handled any events leading up to this point
						var changes = diff(lastDispatchedValues.slice().sort(), currentValues.slice().sort());

						attr.set(this, "values", currentValues); // why do we have to set this here?

						if (changes.length) {
							domDispatch.call(this, "values");
							setData.set.call(this, "lastDispatchedValues", currentValues);
						}
					});
