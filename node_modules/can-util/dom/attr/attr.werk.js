		...
		special: {
			...
			values: {
				...
				set: function(values){
					...
					setData.set.call(this, 'lastDOMValues', attr.get(this, 'values'));
					...
					setupMO(this, function(){
						...
						var lastDOMValues = setData.get.call(this, 'lastDOMValues') || [];
						var changes = diff(lastDOMValues.slice().sort(), lastVal.slice().sort());
